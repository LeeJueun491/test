...
public class ecc_b4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecc_b4);

        toolbar = (Toolbar)findViewById(R.id.toolbar_b4);
        toolbar.setTitleTextColor(Color.parseColor("#ffffff"));
        toolbar.setTitle(R.string.toolbar_b4);
        ...
        bt_eccb4_water.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                transation.replace(R.id.frame_ecc_b4, eccb4_water);
            }
        });
        ...
        bt_eccb4_elect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                transation.replace(R.id.frame_ecc_b4, eccb4_elect);
            }
        });
        ...
        bt_eccb4_trash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                transation.replace(R.id.frame_ecc_b4, eccb4_trash);
            }
        });
        ...
        bt_eccb4_elev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                transation.replace(R.id.frame_ecc_b4, eccb4_elev);
            }
        });
    }
}